...
const DashboardUserCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full rounded-md flex items-center justify-between py-4 bg-cardOverlay cursor-pointer hover:bg-cardHover hover:shadow-md"
    >
      ...
      {/* prettier-ignore */}
      <p className="text-base text-headingColor w-275 min-w-[160px] text-center">{data.name}</p>
      {/* prettier-ignore */}
      <p className="text-base text-headingColor w-275 min-w-[160px] text-center">{data.email}</p>
      {/* prettier-ignore */}
      <p className="text-base text-headingColor w-275 min-w-[160px] text-center">{data.email_verfied ? 'True' : 'False'}</p>
      {/* prettier-ignore */}
      <p className="text-base text-headingColor w-275 min-w-[160px] text-center">{createdAt}</p>
      <div className=" w-275 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
        <p className="text-base text-headingColor"> {data.role}</p>
        {data._id !== user?.user._id && (
          <motion.p
            whileTap={{ scale: 0.75 }}

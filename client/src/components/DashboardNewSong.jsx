...
export const ImageUploader = ({
  ...
  return (
    <label className="flex items-center justify-center h-full p-4">
      <div className="flex flex-col">
        <div className="flex flex-col justify-center items-center cursor-pointer text-headingColor">
...
const DashboardNewSong = () => {
  ...
  return (
    <div className="flex items-center justify-center p-4 border-gray-300 rounded-md">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex items-center justify-between gap-2 w-full flex-wrap">
            <div className="bg-card backdrop-blur-md w-full lg:w-225 h-225 rounded-md border-2 cursor-pointer">
            ...
            <div className="bg-card  backdrop-blur-md w-full lg:w-300 flex items-center justify-center rounded-md border-2 cursor-pointer">
              ...
              {!isAudioLoading && (
                <>
                  {!audioAsset ? (
                    ...
                    <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-md p-2">
